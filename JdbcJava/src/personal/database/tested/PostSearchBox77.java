...
public class PostSearchBox77 extends JFrame implements ActionListener {
	private TextField tf;
	private JButton jbtn;
	private JTable table;
	private JTableModel77 jtm;
	private JPanel jp;
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(e.getClickCount()==2) {
					...
					ZipcodeBean bean=(ZipcodeDao77.selectBean(ZipcodeDao77.getSeq(row)));
	...
	public PostSearchBox77(MemberView77 memberView) {
